<aside id="a2a_follow_widget-2" class="widget widget_a2a_follow_widget">
	<div class="a2a_kit a2a_kit_size_26 a2a_follow addtoany_list" style="line-height: 26px;">
		<a
			...
			target="_blank"
			><span
				class="a2a_svg a2a_s__default a2a_s_github"
				><svg
					focusable="false"
					aria-hidden="true"
					...
					/></svg
				></span
			><span class="a2a_label">GitHub</span></a
		>
		<svg id="Apple" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1{fill:#00f6ef;}.cls-2{fill:#fff;}.cls-3{fill:#ff004f;}</style></defs><rect height="427.97" rx="71.15" width="427.97" x="42.01" y="42.95"/>
