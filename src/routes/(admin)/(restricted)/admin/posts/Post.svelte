      ...
      <div class="p-8 rounded-sm border border-gray-200">
        ...
        <form>
          <div class="mt-8 space-y-6">
            <div>
              <label for="title" class="text-sm text-gray-200 block mb-1 font-medium">Title</label>
              <input
                type="text"
                id="title"
          ...
          <div>
            <label for="fimage" class="text-sm text-gray-200 block mb-1 font-medium">Feature Image</label>
            <input
              type="text"
              id="fimage"
              class="bg-gray-100 border border-gray-200 rounded-sm py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
          ...
          <div>
            <label for="fimage_alt" class="text-sm text-gray-200 block mb-1 font-medium">Feature Image Alt</label>
            <input
              type="text"
              id="fimage_alt"
              class="bg-gray-100 border border-gray-200 rounded-sm py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
